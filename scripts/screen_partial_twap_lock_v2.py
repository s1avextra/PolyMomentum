...
docs/partial_twap_lock_v2_preregistration_2026-08-19.md (with its
...
SEAL = "logs/strategy-research/twap-era-v2/twap_era_v2_20260819.seal.json"
LABELS = "logs/strategy-research/twap-era-v2/twap_labels.parquet"

DECISION_SECONDS = [120, 180, 240]
LOCK_STRENGTH_FLOORS = [0.25, 0.5, 1.0]
...
def main() -> None:
    ...
    result = {
        "schema_version": 1,
        "registration": "partial_twap_lock_v2_screen_20260819",
        "preregistration": "docs/partial_twap_lock_v2_preregistration_2026-08-19.md",
        "dataset_seal": SEAL,
        "labels": LABELS,
