...
- `KILL_SWITCH_PATH=/opt/polymomentum/control/KILL_BAND` did not exist (only a stale `KILL`); created 2026-09-07 so that funding the wallet cannot restart trading on the unfixed rule.
